# The Last Account — Object and Evidence Chain
...
1. Stored in internal document-control cabinet inside original vault.
2. Photographed by Stephen in the prologue.
3. Remains physically in building after Stephen's death.
4. Scheduled for movement and destruction during gala.
5. Recovered physically by Anton in Chapter 23.
6. Transferred during extraction.
...
- Report accuses Stephen.
- Hidden workbook fields and approval records were created after his death.
- Funds remain inside the Weaver Newman/client orbit.
- Nina finds the report independently through Avery's supplied forensic data.
- Used to establish construction of a theft around Stephen's identity.

## Vehicle and death evidence

- Surface-lot entry: 7:36 a.m.
- Manual release: 1:12 a.m.
- Driver is not Stephen.
- Vehicle moves approximately 0.3 miles.
- Engine off: 1:19 a.m.
- Engine on: 1:47 a.m.
- Discovery: 5:41 a.m.
- Ortega calls Rylan before 911.
- Rylan's report classifies Stephen as adverse before discovery.
- Official cause: carbon monoxide.

## Avery surveillance evidence

- Observed through café-owner camera material.
- Traced to a Quincy security firm managed by Owen Price.
- Owen Price previously worked under Rylan Adams.
- Establishes active threat after Avery begins seeking help.

## Chelsea's audit inconsistency

- Deliberate, not error.
- Designed to signal the report is false without openly confessing knowledge.
- Leads Jack to Chelsea.

## Fire and building-control evidence

- Suppression disabled below ballroom.
- Service elevators restricted remotely.
- Unexplained building-control commands detected by Nina.
- Fire is controlled and designed to destroy evidence and witnesses.
- Public evacuation leaves lower-level personnel exposed.
- Rylan and Tomas admissions/supporting records connect fire to deliberate cleanup.

## Evidence distribution

Nina distributes authenticated ledger pages and supporting records during extraction. Distribution must be redundant enough that the physical ledger's later seizure or destruction cannot erase the case.
